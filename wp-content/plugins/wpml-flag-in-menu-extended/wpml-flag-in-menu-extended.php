...
class WPML_Flags {
    ...
    function ConfigSettings() {
        $this->settings_api = WPML_Flags_Settings::getInstance(array(
    ...
    function wpml_flag_in_menu_extended($items, $args) {
        ...
        $this->settings_api = WPML_Flags_Settings::getInstance();

        // get the plugin parameter values
        $img_class = $this->settings_api->get_option('img_class', 'wpml-flag-in-menu-extended_basics', '');
        $img_width = $this->settings_api->get_option('img_width', 'wpml-flag-in-menu-extended_basics', '');
        $img_height = $this->settings_api->get_option('img_height', 'wpml-flag-in-menu-extended_basics', '');
        $li_class = $this->settings_api->get_option('li_class', 'wpml-flag-in-menu-extended_basics', '');
