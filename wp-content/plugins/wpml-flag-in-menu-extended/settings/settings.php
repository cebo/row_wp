...
class WPML_Flags_Settings extends WPML_Flags_Settings_API {
    ...
    public static function getInstance($args = array()) {
        if (!self::$_instance) {
            self::$_instance = new WPML_Flags_Settings($args);
        }
        ...
        $fields = array(
            $pi . '_basics' => array(
                ...
                array(
                    ...
                    'desc' => __('The HTML tag surrounding the language description (if used), it will automatically have the class "wpml_flags_name" as entered in the CSS class for the IMG tag', $pi),
                    'type' => 'radio',
                    'default' => 'span',
                    'options' => array(
