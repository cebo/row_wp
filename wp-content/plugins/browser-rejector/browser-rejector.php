	...
	<div class="wrap">	
		...
		<form method="post" action="options.php">
			...
			<table class="form-table" id="brejectr_tor">
				<!-- IE -->
				<tr valign="top">
					<th scope="row"><?php _e('Internet Explorer', 'browser-rejector'); ?><br /><i>(<?php _e('Current Version', 'browser-rejector') ?>: 11)</i></th>
					<td>
				...
				<!-- Firefox -->
				<tr valign="top">
					<th scope="row"><?php _e('Firefox', 'browser-rejector'); ?><br /><i>(<?php _e('Current Version', 'browser-rejector') ?>: 29)</i></th>
					<td>
				...
				<!-- Chrome -->
				<tr valign="top">
					<th scope="row"><?php _e('Google Chrome', 'browser-rejector'); ?><br /><i>(<?php _e('Current Version', 'browser-rejector') ?>: 34)</i></th>
					<td>
