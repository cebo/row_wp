	...
	<section class="contentarea">
		...
		<div class="page-content">
			...
			<?php if(get_post_meta($post->ID, 'cebo_presslink', true)) { ?>
				...
				<div class="button-wrapper" style="margin: 20px 0;"><a onclick="_gaq.push(['_link', this.href]);return false;" class="button" href="<?php echo get_post_meta($post->ID, 'cebo_presslink', true); ?>">Link to Press</a></div>
