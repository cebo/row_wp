...
$videobox = array (
	'Slide Configuration' => array (
			array( 'youtube', 'If this is a video slide, place the youtube ID here ex: FJw3fH7kzRs' , 'textfield'),
			array( 'vimeo', 'If this is a video slide, place the youtube ID here" ' , 'textfield'),
				),
	...
	// Adds a custom section to the –advanced” Post and Page edit screens
		...
		foreach ( array_keys( $videobox ) as $box_name ) {
			add_meta_box( $box_name, __( $box_name, 'video' ), 'video_post_custom_box', 'imagegalleries', 'normal', 'high' );
			}
		}
		}
